...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.11.1/node_modules/@modelcontextprotocol/sdk/dist/esm/types.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.11.1/node_modules/@modelcontextprotocol/sdk/dist/esm/shared/protocol.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.11.1/node_modules/@modelcontextprotocol/sdk/dist/esm/server/index.js
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.11.1/node_modules/@modelcontextprotocol/sdk/dist/esm/server/completable.js
var McpZodTypeKind;
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.11.1/node_modules/@modelcontextprotocol/sdk/dist/esm/server/mcp.js
var McpServer = class {
...
// node_modules/.pnpm/@modelcontextprotocol+sdk@1.11.1/node_modules/@modelcontextprotocol/sdk/dist/esm/server/stdio.js
import process2 from "node:process";

// node_modules/.pnpm/@modelcontextprotocol+sdk@1.11.1/node_modules/@modelcontextprotocol/sdk/dist/esm/shared/stdio.js
...
// src/public-apis.utils.ts
var CATEGORY_HEADER_PREFIX = "### ";
var MARKDOWN_LINK_REGEX = /\[([^\]]*)\]\(([^)]+)\)/;
var CorsEnum = z.enum(["yes", "no", "unknown"]);
var HttpsEnum = z.enum(["yes", "no", "unknown"]);
var AuthEnum = z.enum([
  "oauth",
  "apikey",
  "x-mashape-key",
...
var PublicApisSchema = z.array(PublicApiSchema);
function parseCors(cors) {
  try {
...
function parsePublicApisMarkdown(markdown) {
...
async function fetchPublicApisMarkdown() {
  const readmeUrl = "https://raw.githubusercontent.com/public-apis/public-apis/refs/heads/master/README.md";
...
var public_apis_categories_default = [
  "animals",
  "anime",
  "anti-malware",
  "art & design",
...
async function main() {
  ...
  server.tool(
    ...
    {
      categories: z.array(z.enum(public_apis_categories_default)).describe("Filter APIs by categories"),
      noAuthOnly: z.boolean().optional().default(true).describe("Return only APIs that do not require authentication")
    },
    ...
    async ({ categories, noAuthOnly }) => {
      try {
        ...
        const text = Object.entries(Object.groupBy(apis, (api) => api.category)).map(([category, _apis]) => {
          return `##${category}
${_apis?.map((api) => `${api.title} - ${api.description} ${api.link}`).join("\n")}
`;
        }).join("\n");
        return {
...
main().catch((error2) => {
  logger.error("Unhandled error in main", error2);
  process.exit(1);
});
